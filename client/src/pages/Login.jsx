...
export default function Example() {
    ...
    const state = queryParms.get("state");
        ...
        <div className="flex h-[100vh] w-full">
            ...
            <div className="w-full flex flex-col items-center justify-center">
                ...
                <form className="md:w-96 w-80 flex flex-col items-center justify-center">
                    <h2 className="text-4xl text-gray-900 font-medium">{state === "SignUp" ? "Sign Up" : "Sign In"}</h2>
                    ...
                    <div className="flex items-center mt-6 w-full bg-transparent border border-gray-300/60 h-12 rounded-full overflow-hidden pl-6 gap-2">
                        ...
                        <input type="password" placeholder="Password" className="bg-transparent text-gray-500/80 placeholder-gray-500/80 outline-none text-sm w-full h-full pr-4" required />
                    </div>
